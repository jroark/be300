...
DISPLAY_CONFIG dc = {
#if	defined(CONFIG_PFS168_MQVGA) || defined(CONFIG_SA1100_ASSABET)
	640,		/* int	x;		x resolution */
	480,		/* int	y;		y resolution */
	16,		/* int	bpp;		color depth */
	60,		/* int	refresh;	CRT refresh rate */
	1280,		/* int	stride;		memory stride */
			/* unsigned long flag;	display flag */
			/* Flag definition */
	0 |		/* PANEL_TYPE_MASK	0x000000ff 	Panel type mask */
			/* PROCESSOR_MASK	0x00003f00 	Mask of processor type */
			/* IS_SH3		0x00000000 */
			/* IS_SH4		0x00000100 */
			/* IS_NEC		0x00000200 */
	IS_SARM |	/* IS_SARM		0x00000300 */
			/* IS_TOSHIBA		0x00000400 */
			/* IS_PCI		0x00000500 */
			/* LCD_ON		0x00010000	LCD mode */
	CRT_ON		/* CRT_ON		0x00020000	CRT mode */
			/* LARGE_DESKTOP        0x00040000	Large desktop mode is on */
			/* INDEP_DISPLAY	0x00080000	Independent display */
			/* SAME_IMAGE		0x00100000	Use 2 GC but same image */
			/* USE_2GCs		0x001C0000	2 GCs are used */
			/* USE_2GCs_MASK	0x001C0000	mask for 2 GCs */
			/* ENA_HW_CURSOR	0x00200000	Enable hw cursor */
			/* HORI_LCD_CRT 	0x00000000	QView hori arrangement */
			/* HORI_CRT_LCD 	0x10000000	QView hori arrangement */
			/* VERT_CRT_LCD		0x20000000	QView vert arrangement */
			/* VERT_LCD_CRT		0x30000000	QView vert arrangement */
#elif	defined(CONFIG_PFS168_MQTFT)
	320,		/* int	x;		x resolution */
	240,		/* int	y;		y resolution */
	16,		/* int	bpp;		color depth */
	60,		/* int	refresh;	CRT refresh rate */
	640,		/* int	stride;		memory stride */
			/* unsigned long flag;	display flag */
			/* Flag definition */
	17 |		/* PANEL_TYPE_MASK	0x000000ff 	Panel type mask */
	0 |		/* PROCESSOR_MASK	0x00003f00 	Mask of processor type */
	0 |		/* IS_SH3		0x00000000 */
	0 |		/* IS_SH4		0x00000100 */
	0 |		/* IS_NEC		0x00000200 */
	IS_SARM |	/* IS_SARM		0x00000300 */
	0 |		/* IS_TOSHIBA		0x00000400 */
	0 |		/* IS_PCI		0x00000500 */
	LCD_ON |	/* LCD_ON		0x00010000	LCD mode */
	CRT_ON |	/* CRT_ON		0x00020000	CRT mode */
	0 |		/* LARGE_DESKTOP        0x00040000	Large desktop mode is on */
	0 |		/* INDEP_DISPLAY	0x00080000	Independent display */
	SAME_IMAGE |	/* SAME_IMAGE		0x00100000	Use 2 GC but same image */
	0 |		/* USE_2GCs		0x001C0000	2 GCs are used */
	0 |		/* USE_2GCs_MASK	0x001C0000	mask for 2 GCs */
	0 |		/* ENA_HW_CURSOR	0x00200000	Enable hw cursor */
	0 |		/* HORI_LCD_CRT 	0x00000000	QView hori arrangement */
	0 |		/* HORI_CRT_LCD 	0x10000000	QView hori arrangement */
	0 |		/* VERT_CRT_LCD		0x20000000	QView vert arrangement */
	0 |		/* VERT_LCD_CRT		0x30000000	QView vert arrangement */
	0 |		/* LCDCRT_POS_MASK	0x30000000	mask for QV orientation */
	0		/* LCDCRT_POS_MASK	0x30000000	mask for QV orientation */
#elif defined(CONFIG_NEC_EAGLE)
	640, 480, 16, 60, 640*2, 0x00030003
#else
#if 0
	800,		/* int	x;		x resolution */
	600,		/* int	y;		y resolution */
	16,		/* int	bpp;		color depth */
	60,		/* int	refresh;	CRT refresh rate */
	1600,		/* int	stride;		memory stride */
#else
	1024,		/* int	x;		x resolution */
	768,		/* int	y;		y resolution */
	8,		/* int	bpp;		color depth */
	60,		/* int	refresh;	CRT refresh rate */
	1024,		/* int	stride;		memory stride */
#endif
			/* unsigned long flag;	display flag */
			/* Flag definition */
	0 |		/* PANEL_TYPE_MASK	0x000000ff 	Panel type mask */
...
int __init mq200fb_init(void)
{
   ...
   if ((i = pci_enable_device(pPciDev)) < 0) {
    ...
    p->mqMmioAddrPhys = 0x4be00000UL;	/* REGISTER_BASE; PFS168_REVISIT */
    p->mqFbAddrPhys = 0x4b800000UL;	/* FB_BASE; PFS168_REVISIT */
...
void onoffdisplay(int display_flag, void *pMQMMIO)
{
	...
	switch (display_flag)
	{
		case ENABLE_LCD_GC1:
			...
			PFS168_SYSCTLA |= PFS168_SYSCTLA_BKLT;
#endif
			break;
