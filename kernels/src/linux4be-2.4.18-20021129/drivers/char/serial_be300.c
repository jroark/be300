...
{
//printk("st: be300_serial_set_termios\n");
}
...
//	printk("be300_uart_interrupt called\n");
	...
	if(!(serial_inb(UART_IIR) & UART_IIR_NO_INT))
	{
...
*/	
	printk("tty00 at 0xAA008680 (irq = 19) is a NEC D89041F1001 UART\n"); 
