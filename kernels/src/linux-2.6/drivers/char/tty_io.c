...
static void release_mem(struct tty_struct *tty, int idx);
 ...
 /*
  * Casio Casiopeia BE-300 init functions
  * Added by John Roark <jroark@cs.usfca.edu>
  * 06-28-2002
  */
 extern void be300_console_init(void);
 extern void be300_init(void);
...
#endif
#ifdef CONFIG_SERIAL_BE300
static struct cdev be300_cdev;
#endif
...
#ifdef CONFIG_SERIAL_BE300
/*
	strcpy(be300_cdev.kobj.name, "dev.be300");
	cdev_init(&be300_cdev, &console_fops);
	if (cdev_add(&be300_cdev, MKDEV(TTY_MAJOR, 0), 1) ||
	    register_chrdev_region(MKDEV(TTY_MAJOR, 0), 1, "/dev/vc/0") < 0)
		panic("Couldn't register /dev/tty0 driver\n");
	devfs_mk_cdev(MKDEV(TTY_MAJOR, 0), S_IFCHR|S_IRUSR|S_IWUSR, "vc/0");
