/****************************************************************************
** $Id: qt/src/kernel/qrichtext_p.h   2.3.10   edited 2005-01-24 $
**
...
public:
    ...
    enum Clear { }; //  move to QStyleSheetItem?
...
public:
    ...
    { }
    QString selectedAnchor() const { }
    QtTriple selectedAnchorStartPos() const{ }
    QtTriple selectedAnchorEndPos() const{ }
#endif
private:
