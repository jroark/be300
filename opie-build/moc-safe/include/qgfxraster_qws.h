/****************************************************************************
** $Id: qt/src/kernel/qgfxraster_qws.h   2.3.10   edited 2005-01-24 $
**
...
public:
    ...
    virtual void setBrushPixmap( const QPixmap * p ) { }
    ...
    virtual void setOpaqueBackground(bool b) { }
    ...
    virtual void setLineStep(int i) { }
    int linestep() const { }
    ...
    virtual void setRop(RasterOp r) { }

    void setClut(QRgb * cols,int numcols) { }
...
protected:
    ...
    unsigned char *srcScanLine(int i) { }
...
protected:
	...
	virtual void hlineUnclipped(int x,int x1,int y){ };
#endif
