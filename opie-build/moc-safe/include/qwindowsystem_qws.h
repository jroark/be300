...
private:
    ...
    int  allocationIndex() const { }
    void setAllocationIndex( int i ) { }
    void updateAllocation();

    void setNeedAck( bool n ) { }
...
#ifndef QT_NO_QWS_IM
    enum IMState { };
    enum IMMouse { }; //MouseMove reserved but not used
...
#endif
    struct SelectionOwner { } selectionOwner;
    QTime timer;
    QWSServerData* d;
